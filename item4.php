...
<body>
	...
	<main>
			<h2 class="text-center bundle-title">The Hitchhiker&#39;s Guide Series</h2>
		<div class="bundles">
			...
			<div class="container">
				<div class="flex child50">
					<div id="pay-extra">
						...
						<p>Douglas Adams&#39; iconic series tries to answer life&#39;s big questions while taking readers on a whimsical adventure through the galaxy. We bring you only the books in the series written by Adams himself. Enjoy, don’t panic, and don’t forget to bring a towel!</p>
					</div>
					<div id="pay-extra">
						<div class="flex flex-center">
